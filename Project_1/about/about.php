    ...
    <?php include('../header.php') ?>
        ...
        <div id="wrapper">
            ...
            <div id="kevin" class="col-md-6 col-lg-6" style="float: left">
                ...
                <br/>My name is Kevin Mangus and I am an Applied Computing Technology Major born and raised in San Diego California. 
                I am currently projected to graduate this fall in 2017.
                I am a car enthusiast, drumming drummer, video game player, dog loving IT technician who also enjoys gorgeous days, being outside, and great mountain biking!
                "A ginger who likes being outside?" Yeahhh I know, I'm pretty different.
                Goals in life: To get a job that is enjoyable and be successful at it, ultimately that way I can work on cars (my one the side passion) and maybe own multiple.
                </p>
            </div> 
